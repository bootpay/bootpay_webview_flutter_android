  ...
  static void pigeon_setUpMessageHandlers({
...

    {
      final BasicMessageChannel<
          Object?> pigeonVar_channel = BasicMessageChannel<
              Object?>(
          'dev.flutter.pigeon.bootpay_webview_flutter_android.WebViewClient.onReceivedError',
          pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (pigeon_clearHandlers) {
        pigeonVar_channel.setMessageHandler(null);
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.bootpay_webview_flutter_android.WebViewClient.onReceivedError was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final WebViewClient? arg_pigeon_instance =
              (args[0] as WebViewClient?);
          assert(arg_pigeon_instance != null,
              'Argument for dev.flutter.pigeon.bootpay_webview_flutter_android.WebViewClient.onReceivedError was null, expected non-null WebViewClient.');
          final WebView? arg_webView = (args[1] as WebView?);
          assert(arg_webView != null,
              'Argument for dev.flutter.pigeon.bootpay_webview_flutter_android.WebViewClient.onReceivedError was null, expected non-null WebView.');
          final int? arg_errorCode = (args[2] as int?);
          assert(arg_errorCode != null,
              'Argument for dev.flutter.pigeon.bootpay_webview_flutter_android.WebViewClient.onReceivedError was null, expected non-null int.');
          final String? arg_description = (args[3] as String?);
          assert(arg_description != null,
              'Argument for dev.flutter.pigeon.bootpay_webview_flutter_android.WebViewClient.onReceivedError was null, expected non-null String.');
  ...
  static void pigeon_setUpMessageHandlers({
    ...
    final BinaryMessenger? binaryMessenger = pigeon_binaryMessenger;
    {
      final BasicMessageChannel<
          Object?> pigeonVar_channel = BasicMessageChannel<
              Object?>(
          'dev.flutter.pigeon.bootpay_webview_flutter_android.WebChromeClient.pigeon_newInstance',
          pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (pigeon_clearHandlers) {
        pigeonVar_channel.setMessageHandler(null);
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.bootpay_webview_flutter_android.WebChromeClient.pigeon_newInstance was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_pigeon_instanceIdentifier = (args[0] as int?);
          assert(arg_pigeon_instanceIdentifier != null,
              'Argument for dev.flutter.pigeon.bootpay_webview_flutter_android.WebChromeClient.pigeon_newInstance was null, expected non-null int.');
          try {
            (pigeon_instanceManager ?? PigeonInstanceManager.instance)
                .addHostCreatedInstance(
              pigeon_newInstance?.call() ??
