...
public class WebViewHostApiImpl implements WebViewHostApi {
  ...
  public void evaluateJavascript(
      Long instanceId, String javascriptString, BTGeneratedAndroidWebView.Result<String> result) {
    final WebView webView = (WebView) instanceManager.getInstance(instanceId);
  ...
  @NonNull
  @Override
  public BTGeneratedAndroidWebView.WebViewPoint getScrollPosition(@NonNull Long instanceId) {
    final WebView webView = Objects.requireNonNull(instanceManager.getInstance(instanceId));
    return new BTGeneratedAndroidWebView.WebViewPoint.Builder()
