...
* **Bootpay Fork**: 최신 webview_flutter_android v4.10.5 기반 마이그레이션
  - Package namespace: `io.flutter.plugins.webviewflutter` → `kr.co.bootpay.webviewflutter`
  - Dart plugin class: `AndroidWebViewPlatform` → `BTAndroidWebViewPlatform`
  - BootpayUrlHelper 통합: 한국 결제 앱 자동 처리 (30+ 앱 지원)
  - WebViewClientProxyApi에 `shouldOverrideUrlLoading` 확장
  - Intent scheme, Custom URL scheme 완벽 지원
  - 카드사 앱카드, 간편결제, 뱅크페이/ISP 모두 지원
* Gradle 8.12.1, Kotlin 2.2.10, Java 17
* Pigeon v25.3.2
